 ...
 **/
export function mdlclass(
    { col = 12, desktop = col, tablet = desktop, phone = tablet } = {},
) {
        ...
        ce(
            ...
            ce(
                ...
                ce(
                    ...
                    ce('img', {
                        src: buildURL('/images/cfrp-logo-top-nav.png'),
                        style: {
                            maxHeight: '50px',
                            marginRight: '15px',
                            textDecoration: 'none',
                ...
                ce(
                    Link,
                    { to: '/authors', style: createNavLinkStyle('authors') },
                    'auteurs',
                ),
                ce(
                    Link,
                    { to: '/plays', style: createNavLinkStyle('plays') },
                    'pièces',
                ),
                ce(
                    Link,
                    { to: '/seasons', style: createNavLinkStyle('seasons') },
                    'saisons',
                ),
                ce(
                    Link,
                    { to: '/genres', style: createNavLinkStyle('genres') },
                    'genres',
                ),
            ),
